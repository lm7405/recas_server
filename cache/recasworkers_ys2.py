...
class RecasWorker(multiprocessing.Process):
    ...
    def __init__(self, missionQ, resultQ, get_process_class, init_data):
        multiprocessing.Process.__init__(self)
        self.missionQ = missionQ
        self.resultQ = resultQ
        self.process_class = get_process_class(init_data)
...
# ---------------------------------------------------------
def Create_WorkerProcesses(get_process_class_func, process_class_init_data):
    ...
    workers = [RecasWorker(missionQ, resultQ, get_process_class_func, process_class_init_data)
